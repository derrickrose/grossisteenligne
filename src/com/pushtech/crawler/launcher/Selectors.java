...
public class Selectors {
   ...
   // listing page
   public static final String LISTING_PAGE_IDENTIFIER = "ul#productsList>li , .gItem .cOverlay";
   public static final String LISTING_PAGE_PRODUCTS = "ul#productsList>li , .gItem .cOverlay";
   public static final String LISTING_PAGE_PRODUCT_LINK = "div.productBox>a , .productBox > a";
